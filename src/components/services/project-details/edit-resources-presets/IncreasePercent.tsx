...
export function increasePercentSubmitFormat(
    presetData: {
        [key: string]: unknown;
    },
...
// eslint-disable-next-line react-refresh/only-export-components
export function increasePercentNote(presetData: {
    [key: string]: unknown;
}): string {
    return (
        "Increased all resources by " +
        ("percent" in presetData ? presetData["percent"] : "25") +
        "%"
    );
}

export default function IncreasePercent({
    resourceValues,
    resources,
    clusters,
    updatePresetData,
